...
const messageCtrl = {
    createMessage: async (req, res) => {
        try {
            ...
            res.json({ msg: 'Create Success!', message:message })
    ...
    getConversations: async (req, res) => {
        try {
            ...
            const conversations = await features.query.sort('-updatedAt')
                .populate('recipients', 'profileImage username fullname')
    ...
    deleteConversation: async (req, res) => {
        try {
            const conservation = await Conversations.findOneAndDelete({
                $or: [
            ...
            await Messages.deleteMany({ conversation: conservation._id })
