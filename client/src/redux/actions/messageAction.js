...
export const addMessage = ({ msg, auth, socket }) => async (dispatch) => {
    try {
        ...
        dispatch({ type: MESS_TYPES.ADD_MESSAGE, payload: res.data.message })
        const { _id, profileImage, fullname, username } = auth.user
        socket.emit('addMessage',{...msg, user: { _id, profileImage, fullname, username }})
    } catch (err) {
